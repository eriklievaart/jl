...
import com.eriklievaart.jl.bundle.rule.RuleEngineParser;
...
public class Activator extends ActivatorWrapper {
	private static final String HOST = "com.eriklievaart.jl.bundle.host";
	private static final String HTTPS = "com.eriklievaart.jl.bundle.https";
	private static final String SERVLET_PREFIX = "com.eriklievaart.jl.bundle.servlet_prefix";
	private static final String EXCEPTION_REDIRECT = "com.eriklievaart.jl.bundle.exception.redirect";
	private static final String RULES = "com.eriklievaart.jl.bundle.rules";
